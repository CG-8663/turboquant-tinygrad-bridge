...
static const menu_item ITEMS[] = {
    ...
    {"5", "Cluster Generative — custom prompt",
     "Type your own prompt, see it run on GX10 GB10 + M3 Ultra Metal",
     "echo 'Enter prompt:' && read p && /opt/homebrew/bin/python3.12 benchmarks/generative_cluster.py --prompt \"$p\"", "gen"},
